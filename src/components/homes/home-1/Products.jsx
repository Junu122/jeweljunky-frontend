...
export default function Products() {
  ...
  const handleLoad = () => {
    ...
    setTimeout(() => {
      setDisplayCount(4); // Show up to 24 products
      setLoading(false);
      setLoaded(true);
    }, 1000);
  };
  ...
  return (
    <section className="flat-spacing-5 pt_0 flat-seller" style={{marginTop:"35px"}}>
      <div className="container">
        ...
        <div
          ...
          data-grid="grid-4"
        >
          {dummyJewellery.slice(0, displayCount).map((product, i) => (
